/**
 * Layer 1 — Fetch: download and extract Stanford Dogs images (local files).
 */
...
async function main() {
  if (existsSync(IMAGES_DIR)) {
    ...
    console.log("Next: npm run dataset:dog:stanford:process");
    return;
  }
  ...
  console.log("Stanford Dogs ready.");
  console.log("Next: npm run dataset:dog:stanford:process");
}
