/**
 * Layer 1 — Fetch bird & bunny photos into data/other-pet-photos/manifest.json.
 */
...
import {
  matchPixabayOtherPetPhoto,
  OTHER_PET_PHOTO_HARVEST,
} from "../lib/otherPetPhotoFilter.mjs";
import {
  clearPixabayCache,
...
async function main() {
  ...
  console.log("Next: npm run dataset:other:process");
}
